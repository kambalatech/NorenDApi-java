...
public class NorenDExampleApp {
    ...
    public static void main(String[] args) {
        ...
        String response = api.login("ANNAPPADLR", "Abc@123", "RRRRR1997R", "Krishna_DAPI", "krishpernad123", "java-");
        ...
        // JSONObject reply = api.place_order("B","C","TSTINV3", "NSE", "CANBK-EQ", 1, 0, "LMT", 220.0, "java", null, null, null, null, null, null, null, null); 
        ...
        // JSONObject test= api.modify_order("22122800000006","NSE","AARVI-EQ",50,"DS",610.0, 0.0, 0.0 ,0.0 , 0.0,"TSTINV3"); 
        ...
        JSONArray exchmsg = api.get_exchmsg(); 
